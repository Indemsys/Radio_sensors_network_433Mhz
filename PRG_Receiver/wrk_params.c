...
{
  {                     
    "SFLAGS",               // Строковое описание
    &ee_wp.flags,           // Указатель на значение переменной в EEPROM
    &wp.flags,              // Указатель на значение переменной в RAM
    tunsigned_int,          // Идентификатор типа переменной
    0,                      // Значение по умолчанию
    0,                      // Минимальное возможное значение
    65535,                  // Максимальное возможное значение
    0,                      // Количество знаков после запятой
    0,                      // Аттрибуты переменной
    0,                      // Указатель на функцию выполняемую после редактирования
    sizeof(unsigned int)    // Длинна переменной
  },                    
  {                     
    "PREAMB",           
    &ee_wp.preamble,    
